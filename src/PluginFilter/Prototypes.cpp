...
vx::Node* ColorizeLabeledSurfacePropertiesCopy::inputSurface() {
...
vx::Node* ColorizeLabeledSurfacePropertiesCopy::inputTable() {
  return vx::PropertyValueConvertRaw<QDBusObjectPath, vx::Node*>::fromRaw(
      vx::Node::parseVariant<QDBusObjectPath>(
          (*_properties)["de.uni_stuttgart.Voxie.Filter.ColorizeLabeledSurface."
                         "InputTable"]));
...
vx::Node* ColorizeLabeledSurfacePropertiesCopy::output() {
  return vx::PropertyValueConvertRaw<QDBusObjectPath, vx::Node*>::fromRaw(
      vx::Node::parseVariant<QDBusObjectPath>(
          (*_properties)
              ["de.uni_stuttgart.Voxie.Filter.ColorizeLabeledSurface.Output"]));
...
vx::Node* ColorizeSurfaceFromAttributePropertiesCopy::inputSurface() {
  return vx::PropertyValueConvertRaw<QDBusObjectPath, vx::Node*>::fromRaw(
      vx::Node::parseVariant<QDBusObjectPath>(
          (*_properties)["de.uni_stuttgart.Voxie.Filter."
...
vx::Node* ColorizeSurfaceFromAttributePropertiesCopy::output() {
  return vx::PropertyValueConvertRaw<QDBusObjectPath, vx::Node*>::fromRaw(
      vx::Node::parseVariant<QDBusObjectPath>(
          (*_properties)["de.uni_stuttgart.Voxie.Filter."
...
vx::Node* CreateSurfacePropertiesCopy::inputVolume() {
  return vx::PropertyValueConvertRaw<QDBusObjectPath, vx::Node*>::fromRaw(
      vx::Node::parseVariant<QDBusObjectPath>(
          (*_properties)
              ["de.uni_stuttgart.Voxie.Filter.CreateSurface.InputVolume"]));
...
vx::Node* CreateSurfacePropertiesCopy::labelVolume() {
  return vx::PropertyValueConvertRaw<QDBusObjectPath, vx::Node*>::fromRaw(
      vx::Node::parseVariant<QDBusObjectPath>(
          (*_properties)
              ["de.uni_stuttgart.Voxie.Filter.CreateSurface.LabelVolume"]));
...
vx::Node* CreateSurfacePropertiesCopy::output() {
  return vx::PropertyValueConvertRaw<QDBusObjectPath, vx::Node*>::fromRaw(
      vx::Node::parseVariant<QDBusObjectPath>(
...
TableFilterPropertiesCopy::TableFilterPropertiesCopy(
    const QSharedPointer<const QMap<QString, QVariant>>& properties)
    : _properties(properties) {}
QList<vx::Node*> TableFilterPropertiesCopy::input() {
...
vx::Node* TableFilterPropertiesCopy::output() {
  return vx::PropertyValueConvertRaw<QDBusObjectPath, vx::Node*>::fromRaw(
      vx::Node::parseVariant<QDBusObjectPath>(
          (*_properties)["de.uni_stuttgart.Voxie.Output"]));
}
