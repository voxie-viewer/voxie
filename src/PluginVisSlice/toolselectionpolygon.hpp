...
//class ToolSelectionPolygon : public Visualizer2DTool
//{
//    Q_OBJECT
//public:
//    ToolSelectionPolygon(QWidget *parent, SliceVisualizer* sv);
//    ~ToolSelectionPolygon(){}

//    QIcon getIcon() override {return QIcon(":/icons/ruler--pencil.png");}
//    QString getName() override{return "selection rectangle";}
//public slots:
