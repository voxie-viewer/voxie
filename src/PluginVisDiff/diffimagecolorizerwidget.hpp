...
/**
 * @brief The DiffImageColorizerWidget class provides an ui wrapper around a colorizer. It can add, change and remove color mappings. It also displays this information in a section.
 * @author Hans Martin Berner
 */
class DiffImageColorizerWidget : public QWidget
{
    Q_OBJECT
public:
    DiffImageColorizerWidget(QWidget *parent = 0);
    ~DiffImageColorizerWidget();
private:
