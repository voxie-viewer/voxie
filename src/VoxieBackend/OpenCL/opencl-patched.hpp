 ...
 *   build variants.
 *
 * - CL_HPP_NO_DEFAULT_OBJECTS
 *
 *   Disable getDefault() methods.
 *
 *
 ...
 *
 * - CL_HPP_OPENCL_HEADER_FILE
 *
 *   The header file which should be included instead of <CL/opencl.h>.
 *
 *
...
{
private:
#ifndef CL_HPP_NO_DEFAULT_OBJECTS
